  ...
  return (
    <Layout>
      <main className={styles.main}>
        ...
        >
          <StaticImage
            src={"../images/profile_pic_2018.jpg"}
        ...
        <p>
          ...
          neural networks in and outside of the classroom, as well as building
          and deploying web applications with React.JS and GraphQL.{" "}
        </p>
        <h2>Hobbies</h2>
        <p>
