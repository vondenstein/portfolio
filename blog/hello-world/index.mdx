...
My approach to this site is similar to the one above. I'm going to put this "documentation" out there, and maybe it will have an impact. But if it doesn't, that's okay, because it can be a reminer to myself that I have something that's worth putting out there.
